...
public class ModSubject extends JFrame {
   ...
   public ModSubject() {
      ...
      JLabel lblNewLabel = new JLabel("과목수정");
               ...
               if (e.getSource().equals(button)) {
                  ...
                  if ((textField.getText().isEmpty()) == true && (textField_1.getText().isEmpty()) == true) {
                     JOptionPane.showMessageDialog(null, "비어있는 칸이 존재합니다.");
                        ...
                        JOptionPane.showMessageDialog(null, "과목명을 입력해주세요.");
                     
                  } else {

                     sql = "Update Subject Set Subjectname='" + textField.getText() + "',professor='"
                           + textField_1.getText() + "',day='" + comboBox_2.getSelectedItem() + "',time='"
                           + comboBox.getSelectedItem() + "',year='" + comboBox_1.getSelectedItem()
                           + "',semester='" + comboBox_3.getSelectedItem() + "'where subjectname='"
                           + textField.getText() + "';";

                     stmt.executeUpdate(sql);
                     JOptionPane.showMessageDialog(null, "과목 세부사항 수정이 완료 되었습니다.");
                     setVisible(false);
                     SeeSubject frame = new SeeSubject();
                     frame.setVisible(true);
                  }
